...
export declare enum ISOCountryCode {
    Afghanistan = "AF",
    AlandIslands = "AX",
    Albania = "AL",
    Algeria = "DZ",
...
export declare enum ISOCountryCode3 {
    Afghanistan = "AFG",
    AlandIslands = "ALA",
    Albania = "ALB",
    Algeria = "DZA",
...
export declare enum ISOLanguageCode {
    Afrikaans = "af",
    Albanian = "sq",
    Amharic = "am",
    Arabic = "ar",
...
export declare enum ISOCurrencyCode {
    Afghani = "AFN",
    AlgerianDinar = "DZD",
...
export declare enum WorldRegion {
    Asia = "Asia",
    Europe = "Europe",
